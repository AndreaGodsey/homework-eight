var homeContent = `<section class="BreakfastNook">
<div class="callout">
...
<div class="titleofclient">Client Testimonials</div>
  <section class="nameone">Katelina Fish
  <p class="para1">
    Lorem ipsum dolor, sit amet consectetur adipisicing elit. Corrupti
    repellendus repellat cumque, harum ab, at cum aliquid architecto
    doloremque molestiae vitae consectetur minus beatae suscipit sed
  ...
  <section class="nametwo">Catherine Castanza
  <p class="para2">
    Lorem ipsum dolor, sit amet consectetur adipisicing elit. Corrupti
    repellendus repellat cumque, harum ab, at cum aliquid architecto
    doloremque molestiae vitae consectetur minus beatae suscipit sed
  ...
  <section class="namethree">Jeremy Ross<p class="para3">
  Lorem ipsum dolor, sit amet consectetur adipisicing elit. Corrupti
  repellendus repellat cumque, harum ab, at cum aliquid architecto
  doloremque molestiae vitae consectetur minus beatae suscipit sed
  illum nemo magnam facilis.Lorem ipsum dolor, sit amet consectetur
...
var aboutContent = ` <section class="aboutimage">
...
var menuContent = ` <section class="menuimagetop">
        <section class="BreakfastNook">
          <div class="callout">
            <div class="quote">
...
var contactContent = `<section class="menuimagetop">
<section class="BreakfastNook">
  <div class="callout">
    <div class="quote">
